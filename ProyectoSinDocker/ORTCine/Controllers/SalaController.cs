...
namespace ORTCine.Controllers
{
    public class SalaController : Controller
    {
        ...
        public SalaController(ORTCineDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("salaID,numeroSala,capacidadMax")] Sala sala)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("salaID,numeroSala,capacidadMax")] Sala sala)
        {
            if (id != sala.salaID)
            {
                return NotFound();
